...
{
    [ViewComponent(Name = "_FeaturedProducts")]
    public class _FeaturedProducts : ViewComponent
    {
        ...
        {
            IQueryable<ProductEntity> listProducts = await _productService.GetListAllProductsByTypeAsync((int)ProductTypeEnum.Featured);
