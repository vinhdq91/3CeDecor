...
{
    [ViewComponent(Name = "_TopRate")]
    public class _TopRate : ViewComponent
    {
        ...
        {
            IQueryable<ProductEntity> listProducts = await _productService.GetListAllProductsByTypeAsync((int)ProductTypeEnum.TopRate);
            ...
            ViewBag.MaxProductDisplay = MaxProductDisplay;
